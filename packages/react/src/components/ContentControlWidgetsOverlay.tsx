...
} from "@stll/folio-core/prosemirror/plugins/contentControlWidgets";
import type { ContentControlWidgetEvent } from "@stll/folio-core/prosemirror/plugins/contentControlWidgets";
