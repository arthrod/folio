...
function forEachParagraph(blocks: readonly BlockContent[], visit: ParagraphVisitor): void {
...
function isDocumentBody(value: unknown): value is Document["package"]["document"] {
...
function isBlockSdt(value: unknown): value is Extract<BlockContent, { type: "blockSdt" }> {
