...
import { expectImageAttrs, mergeImageAttrs } from "@stll/folio-core/prosemirror/attrs";
import type { ImageAttrs, ImagePositionAttrs } from "@stll/folio-core/prosemirror/schema/nodes";
import {
...
} from "@stll/folio-core/types/documentEnumValues";
import { isSafeImageFile } from "@stll/folio-core/utils/imageValidation";
...
function constrainImageSize(width: number, height: number): { width: number; height: number } {
