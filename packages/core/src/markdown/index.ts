...
export type { ImageMeta, ImageRef, MarkdownOptions, MarkdownResult } from "./types";
 ...
 */
export function toMarkdownResult(doc: Document, opts?: MarkdownOptions): MarkdownResult {
