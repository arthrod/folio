 ...
 */
export type FragmentFor<TKind extends Fragment["kind"]> = Extract<Fragment, { kind: TKind }>;
 ...
 */
export type MeasureFor<TKind extends Fragment["kind"]> = TKind extends "paragraph"
  ? ParagraphMeasure
  : TKind extends "table"
    ? TableMeasure
    : TKind extends "image"
