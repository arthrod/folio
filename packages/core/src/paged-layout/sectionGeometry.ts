 ...
 */
export const twipsToPxOr = (twips: number | null | undefined, fallbackPx: number): number =>
 ...
 */
const pageDimToPx = (twips: number | null | undefined, fallbackPx: number): number =>
  twips !== null && twips !== undefined && twips > 0 ? twipsToPixels(twips) : fallbackPx;
...
export const getMargins = (sectionProps: SectionProperties | null | undefined): PageMargins => ({
