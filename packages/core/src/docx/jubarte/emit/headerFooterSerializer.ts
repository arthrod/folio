// PORT (jubarte save path): self-contained copy of docx/serializer/headerFooterSerializer.ts.
...
export function buildNamespaceDeclarations(): string {
...
export function serializeWatermarkParagraph(hf: HeaderFooter): string {
