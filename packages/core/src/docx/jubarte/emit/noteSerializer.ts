// PORT (jubarte save path): note-part serializer lifted from the deleted
// docx/serializer/noteSerializer.ts, re-based onto the emit ports. Used by
// the save orchestrator's note-splice pass to detect edited note paragraphs
// against a re-parse baseline (legacy full-repack semantics).
/**
