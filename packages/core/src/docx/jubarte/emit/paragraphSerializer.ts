// PORT (jubarte save path): self-contained copy of docx/serializer/paragraphSerializer.ts.
...
export function extractPPrInner(pPrXml: string): string {
 ...
 */
export function serializeParagraphContent(
