// PORT (jubarte save path): self-contained copy of docx/serializer/runSerializer.ts.
// Deleted together with docx/serializer/* when the legacy save is removed.
// Do not import from docx/serializer/* here — this tree must stay standalone.
/**
 ...
 */
export function serializeTextContent(content: TextContent): string {
  const needsPreserve =
 ...
 */
export function serializeBreakContent(content: BreakContent): string {
  const attrs: string[] = [];
 ...
 */
export function serializeSymbolContent(content: SymbolContent): string {
 ...
 */
export function serializeFieldChar(content: FieldCharContent): string {
 ...
 */
export function serializeInstrText(content: InstrTextContent): string {
  const needsPreserve =
