// PORT (jubarte save path): self-contained copy of docx/serializer/tableSerializer.ts.
 ...
 */
export function serializeTableGrid(columnWidths: number[] | undefined): string {
