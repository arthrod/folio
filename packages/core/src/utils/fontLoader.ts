 ...
 */
export async function loadFontsWithMapping(families: string[] | undefined): Promise<void> {
 ...
 */
export function canRenderFont(fontFamily: string, fallbackFont = "sans-serif"): boolean {
  if (typeof document === "undefined") {
    return false;
  }
