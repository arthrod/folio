...
import { measuredLineAdvance, measuredLineContentOffset } from "../../layout-engine/lineFlow";
import {
  buildRunFontStyle,
 ...
 */
export function snapPastTrailingSurrogate(text: string, offset: number): number {
