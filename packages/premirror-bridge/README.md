...
A **separately-versioned folio plugin** (Constraint #0, home (b)): a
...
segment-fit seam (Workstream E-1) and record it in the consumer's
`PLATFORM_VERSIONS.md`. That is the only ship-time change; the source does not
move.
